...
export const MemberRoleNames: Record<MemberRole, string> = {
  ...
  [MemberRole.YouthMinistryMember]: 'Miembro ~ (Min. Jóvenes)',
  ...
  [MemberRole.BiblicalTeachingMinistryLeader]: 'Min. Discipulado (Líder)',
  [MemberRole.BiblicalTeachingMinistryCoLeader]: 'Min. Discipulado (Co-Líder)',
  [MemberRole.BiblicalTeachingMinistryMember]: 'Min. Discipulado (Miembro)',
