...
export interface AlertPromotionProps {
  isPromoteButtonDisabled: boolean;
  isInputDisabled: boolean;
  onPromote: () => void;
  /** Título del diálogo, ej: "Promover a este Supervisor" */
  title: string;
  /** Badge de transición de cargo, ej: "Supervisor → Co-Pastor" */
  promotionBadge: string;
  /** Lista de puntos informativos (máx. 4) */
  infoItems: string[];
}

export const AlertPromotion = ({
  ...
  promotionBadge,
  infoItems,
}: AlertPromotionProps): JSX.Element => {
  return (
    <AlertDialog>
              ...
              <div className='flex items-start gap-3'>
                ...
                <div>
                  ...
                  <p className='text-[12px] text-red-600 dark:text-red-300/90 font-inter leading-relaxed'>
                    Esta acción no se puede deshacer. Asegúrate de revisar la información antes de
                    confirmar.
                  </p>
                </div>
              </div>
