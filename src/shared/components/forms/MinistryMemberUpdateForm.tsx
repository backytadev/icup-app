...
export interface MinistryMemberUpdateFormProps {
...
export const MinistryMemberUpdateForm = ({
  isInputDisabled,
  addMinistryBlock,
  ministryBlocks,
  updateMinistryBlock,
  ...
  toggleRoleInBlock,
  removeMinistryBlock,
}: MinistryMemberUpdateFormProps) => {
  return (
    <>
      <div className='w-full flex items-center justify-between border-b border-gray-300 pb-4'>
        <h3 className='text-[16px] font-bold text-black dark:text-gray-100'>Agregar Ministerios</h3>
      ...
      {ministryBlocks.map((block, index) => {
        const selectedChurch = queryChurches?.data?.find((c) => c.id === block.churchId);
        const selectedMinistry = block.ministries?.find((m) => m.id === block.ministryId);
          ...
          <Collapsible key={index} className='border rounded-lg bg-white/5'>
            <div className='flex items-center justify-between px-4 py-3'>
              <div className='flex flex-col'>
                <span className='text-md font-medium pb-1'>Ministerio {index + 1}</span>
            ...
            <CollapsibleContent className='px-4 pb-4 pt-2 data-[state=open]:animate-slideDown data-[state=closed]:animate-slideUp overflow-hidden'>
              <div key={index} className='w-full flex flex-col space-y-4'>
                <div className='grid grid-cols-1 md:grid-cols-1 gap-2'>
                  ...
                  {/* IGLESIA */}
                  <div className='flex flex-col'>
                    <label className='text-[14px] md:text-[14px] font-bold mb-2'>Iglesia</label>
                    <Popover
                  ...
                  {/* MINISTERIO */}
                  <div className='flex flex-col'>
                    <label className='text-[14px] md:text-[14px] font-bold mb-2'>Ministerio</label>
                    <Popover
                ...
                {/* ROLES DE MINISTERIO */}
                <div className='flex flex-col'>
                  <label className='text-[14px] font-bold mb-2'>Roles de Ministerio</label>
