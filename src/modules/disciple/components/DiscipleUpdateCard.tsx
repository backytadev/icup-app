...
import { DiscipleUpdateForm } from '@/modules/disciple/components/forms/DiscipleUpdateForm';
...
export const DiscipleUpdateCard = ({ idRow }: DiscipleUpdateCardProps): JSX.Element => {
  //* States
