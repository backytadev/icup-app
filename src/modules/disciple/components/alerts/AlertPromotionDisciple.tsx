      ...
      <AlertDialogContent className='w-[90vw]'>
        <AlertDialogHeader className='h-auto'>
          <AlertDialogTitle className='dark:text-yellow-500 text-amber-500 font-bold text-xl text-center md:text-[25px] pb-3 flex flex-col'>
            ...
            <p className='w-full text-center md:p-2'>Discípulo?</p>
          </AlertDialogTitle>
          <AlertDialogDescription>
            ...
            <span className='text-left inline-block mb-2 text-[14px] md:text-[15px] leading-relaxed'>
              ...
              caso, deberás asignar un Supervisor al nuevo Predicador promovido.
            </span>

            <span className='text-left inline-block mb-2 text-[14px] md:text-[15px] leading-relaxed'>
              ✅ Una vez que guardes los cambios, el sistema eliminará automáticamente las
              relaciones que tenía el discípulo anteriormente.
            </span>
