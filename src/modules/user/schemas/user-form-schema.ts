...
export const userFormSchema = z
  .object({
    ...
    password: z.union([strongPassword, numericPassword, z.literal('')]).optional(),

    passwordConfirm: z.union([strongPassword, numericPassword, z.literal('')]).optional(),
  ...
  .refine(
    (data) => {
      // Solo validar si alguno de los campos tiene valor
