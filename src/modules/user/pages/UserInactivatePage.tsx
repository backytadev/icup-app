...
import { userInactivateColumns as columns } from '@/modules/user/components/data-tables/columns/user-inactivate-columns';
...
export const UserInactivatePage = (): JSX.Element => {
  //* States
  ...
  return (
    <div>
      ...
      <SearchTitle isInactivateSearch className='text-red-500' titleName={'usuarios'} />
