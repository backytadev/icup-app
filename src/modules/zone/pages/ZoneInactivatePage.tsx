...
export const ZoneInactivatePage = (): JSX.Element => {
  //* States
  ...
  return (
    <div className='animate-fadeInPage'>
      ...
      <SearchTitle isInactivateSearch className='text-red-500' titleName={'zonas'} />
                  ...
                  return (
                    <FormItem>
                      ...
                      >
                        ...
                        <SelectContent>
                          {Object.entries(ZoneSearchTypeNames).map(
                            ([key, value]) =>
                              key !== ZoneSearchType.RecordStatus && (
                                <SelectItem
