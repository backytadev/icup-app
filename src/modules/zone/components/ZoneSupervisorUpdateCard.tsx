...
import { ZoneSupervisorExchangeUpdateForm } from '@/modules/zone/components/forms';

import { Button } from '@/shared/components/ui/button';
import { ResponsiveModal } from '@/shared/components/modal';

interface ZoneSupervisorUpdateCardProps {
  idRow: string;
}

export const ZoneSupervisorUpdateCard = ({
  idRow,
}: ZoneSupervisorUpdateCardProps): JSX.Element => {
  //* States
