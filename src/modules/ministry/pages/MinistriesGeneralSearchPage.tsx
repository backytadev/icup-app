...
import { GeneralMinistrySearchDataTable } from '@/modules/ministry/components/data-tables/boards/general-ministry-search-data-table';
...
export const MinistriesGeneralSearchPage = (): JSX.Element => {
  ...
  return (
    <div className='animate-fadeInPage'>
      ...
      <SearchTitle isGeneralSearch titleName={'ministerios'} />
