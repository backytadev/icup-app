...
export const MinistriesSearchPageByTerm = (): JSX.Element => {
  ...
  useEffect(() => {
    document.title = 'Buscar Ministerios por Filtros - IcupApp';
  }, []);
    ...
    <div className='min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950'>
      ...
      <div className='max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6'>
        <MinistryModuleHeader
          ...
          description='Consulta ministerios utilizando filtros avanzados como nombre, tipo, pastor, ubicación, fecha de fundación y más.'
          titleColor='sky'
        />
...
export default MinistriesSearchPageByTerm;
