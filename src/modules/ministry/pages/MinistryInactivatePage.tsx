...
import { ministryInactivateColumns as columns } from '@/modules/ministry/components/tables/columns';
...
export const MinistryInactivatePage = (): JSX.Element => {
  ...
  useEffect(() => {
    document.title = 'Inactivar Ministerios - IcupApp';
  }, []);
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950'>
      ...
      <div className='max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6'>
        <MinistryModuleHeader
          title='Inactivar Ministerios'
          description='Busca y selecciona un ministerio para inactivar su registro.'
          titleColor='red'
        />
        ...
        {isTermFilterDisabled && (
          ...
          >
            <SearchByTermForm
              ...
              excludeSearchTypes={[MinistrySearchType.RecordStatus]}
            />
          </MinistryFormCard>
        )}
