...
import { ministryInactivateColumns as columns } from '@/modules/ministry/components/data-tables/columns/ministry-inactivate-columns';
...
} from '../enums/ministry-search-sub-type.enum';
...
export const MinistryInactivatePage = (): JSX.Element => {
  //* States
  ...
  return (
    <div className='animate-fadeInPage'>
      ...
      <SearchTitle isInactivateSearch className='text-red-500' titleName={'ministerios'} />
                  ...
                  return (
                    <FormItem>
                      ...
                      >
                        ...
                        <SelectContent>
                          {Object.entries(MinistrySearchTypeNames).map(
                            ([key, value]) =>
                              key !== MinistrySearchType.RecordStatus && (
                                <SelectItem
...
export default MinistryInactivatePage;
