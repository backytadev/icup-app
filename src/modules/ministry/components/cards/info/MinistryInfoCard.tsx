...
export const MinistryInfoCard = ({ idRow }: ChurchInfoCardProps): JSX.Element => {
  //* States
  const dataSearchGeneralResponse = useMinistryStore((state) => state.dataSearchGeneralResponse);
  const dataSearchByTermResponse = useMinistryStore((state) => state.dataSearchByTermResponse);
