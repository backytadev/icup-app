          ...
          <CardContent className='grid grid-cols-3 pl-[1.5rem] pr-[1rem] sm:pl-[4rem] sm:pr-[5rem] gap-x-4 gap-y-2 md:gap-x-6 md:gap-y-4 md:pl-[4.8rem] md:pr-[2rem]'>
            ...
            <div className='space-y-1 col-start-1 col-end-3'>
              ...
              <div className='px-2 text-[14px] md:text-[14.5px]'>
                <ul className='pl-5 flex flex-row gap-x-10 gap-y-2 list-disc'>
                  {data?.serviceTimes !== undefined && data?.serviceTimes.length > 0 ? (
                    data?.serviceTimes.map((serviceTime) =>
                      Object.keys(MinistryServiceTimeNames).map(
                        (serviceTimeName) =>
            ...
            <span
              className={cn(
                'pt-1 md:pt-0 col-start-1 col-end-4 row-start-4 row-end-5 md:row-start-auto md:row-end-auto text-[15px] md:text-[16px] font-bold text-teal-500',
                data?.inactivationCategory && 'col-start-1 col-end-4 row-start-4 row-end-5'
              )}
            >
              Información de Lideres y Co-Lideres
            </span>

            <div className='space-y-1 col-start-1 col-end-2'>
              <Label className='text-[14px] md:text-[15px]'>Lideres</Label>
              <CardDescription className='px-2 text-[14px] md:text-[14.5px]'>
                {data?.leaders?.length ?? '-'}
              </CardDescription>
              <PopoverDataCard
                data={data?.leaders?.map((item) => item.memberInfo) ?? []}
                title={'Lideres'}
            ...
            <div className='space-y-1'>
              <Label className='text-[14px] md:text-[15px]'>Co-Lideres</Label>
              <CardDescription className='px-2 text-[14px] md:text-[14.5px]'>
                {data?.coLeaders?.length ?? '-'}
              </CardDescription>
              <PopoverDataCard
                data={data?.coLeaders?.map((item) => item.memberInfo) ?? []}
                title={'Co-Lideres'}
                moduleName={'Ministerio'}
                firstValue={'firstNames'}
                secondValue={'lastNames'}
            ...
            <div className='space-y-1'>
              ...
              <PopoverDataCard
                data={data?.members?.map((item) => item.memberInfo) ?? []}
                title={'Miembros'}
                moduleName={'Ministerio'}
                firstValue={'firstNames'}
                secondValue={'lastNames'}
            ...
            <div
              className={cn(
                'space-y-1 col-start-1 col-end-4 flex justify-between items-center row-start-9 row-end-10 md:grid md:row-start-7 md:row-end-8 md:col-start-2 md:col-end-4',
            ...
            <div
              className={cn(
                'space-y-1 col-start-1 col-end-4 flex justify-between md:justify-center items-center row-start-12 row-end-13 md:grid md:row-start-7 md:row-end-8 md:col-start-3 md:col-end-4',
                data?.inactivationCategory &&
