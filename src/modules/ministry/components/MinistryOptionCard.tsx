...
interface MinistryOptionCardProps {
  to: string;
  icon: ReactNode;
  title: string;
  description: string;
  color: 'green' | 'blue' | 'sky' | 'orange' | 'red' | 'amber';
  disabled?: boolean;
  delay?: string;
}
...
const colorVariants = {
  ...
  amber: {
    ...
    darkGradient: 'dark:from-amber-600 dark:via-orange-700 dark:to-yellow-700',
...
export const MinistryOptionCard = ({
  to,
  icon,
  title,
  description,
  ...
  disabled = false,
  delay = '0.2s',
}: MinistryOptionCardProps): JSX.Element => {
