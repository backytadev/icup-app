...
import { MinistrySearchSubTypeNames } from '@/modules/ministry/enums/ministry-search-sub-type.enum';
import { MinistrySearchSelectOptionNames } from '@/modules/ministry/enums/ministry-search-select-option.enum';
...
export function SearchByTermMinistryDataTable<TData, TValue>({
  ...
  const setDataSearchByTermResResponse = useMinistryStore(
  ...
  const query = useQuery({
    ...
    queryFn: () => getMinistriesByTerm(searchParams as MinistryQueryParams),
        ...
        <div>
          ...
          <div>
            ...
            <span className='font-medium text-[14px] md:text-[14.5px] italic'>
              {`${
                Object.entries(MinistrySearchTypeNames).find(
            ...
            {(dataForm?.searchType === MinistrySearchType.FirstNames ||
              ...
              <span className='font-medium text-[14px] md:text-[14.5px] italic'>
                ...
                -{' '}
                {`${
                  Object.entries(MinistrySearchSubTypeNames).find(
          ...
          <div>
            ...
            {dataForm?.searchType === MinistrySearchType.FoundingDate && (
            ...
            {(dataForm?.searchType === MinistrySearchType.RecordStatus ||
              ...
              <span className='font-medium text-[14px] md:text-[15px] italic'>
                {`${
                  Object.entries(MinistrySearchSelectOptionNames).find(
          ...
          <div className='pb-8 pt-4 lg:pb-8 grid grid-cols-2 gap-4 lg:flex lg:items-center lg:py-4 lg:gap-3'>
            <div className='flex w-full col-span-2 gap-2 md:gap-3 md:row-start-1 md:row-end-2'>
              <Input
                ...
                value={(table.getColumn('ministryType')?.getFilterValue() as string) ?? ''}
                onChange={(event) =>
                  table.getColumn('ministryType')?.setFilterValue(event.target.value)
                }
              ...
              <Button
                ...
                onClick={() => {
                  table.getColumn('ministryType')?.setFilterValue('');
          ...
          <div className='flex flex-col md:flex-row gap-y-2 items-center'>
            {!query.isPending && (
              <Button
                ...
                variant='ghost'
                className={cn(
                  'px-4 py-3 text-[14px] md:text-[15px] font-semibold rounded-lg shadow-lg transition-transform transform focus:outline-none focus:ring-red-300',
