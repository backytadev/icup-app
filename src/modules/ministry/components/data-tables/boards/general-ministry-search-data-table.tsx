...
export function GeneralMinistrySearchDataTable<TData, TValue>({
  ...
  const isFiltersSearchGeneralDisabled = useMinistryStore(
    (state) => state.isFiltersSearchGeneralDisabled
  );
  const setIsFiltersSearchGeneralDisabled = useMinistryStore(
    (state) => state.setIsFiltersSearchGeneralDisabled
  );
  const setDataSearchGeneralResponse = useMinistryStore(
  ...
  const generateReportQuery = useQuery({
    queryKey: ['general-ministries-report', searchParams],
