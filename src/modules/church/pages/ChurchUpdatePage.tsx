...
export const ChurchUpdatePage = (): JSX.Element => {
  ...
  useEffect(() => {
    document.title = 'Actualizar Iglesia - IcupApp';
  }, []);
  ...
  const getSearchTypeLabel = (): string => {
    if (!dataForm?.searchType) return 'Búsqueda para actualización';
    ...
    <div className='min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950'>
      ...
      <div className='max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6'>
        ...
        <ChurchModuleHeader
          ...
          description='Busca y selecciona una iglesia o anexo para modificar su información.'
          titleColor='orange'
        />
        ...
        {isFiltersSearchByTermDisabled && (
          <ChurchFormCard
            ...
            description='Utiliza los filtros para encontrar la iglesia que deseas actualizar.'
          >
