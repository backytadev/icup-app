...
import { churchUpdateColumns as columns } from '@/modules/church/components/data-tables/columns/church-update-columns';
...
export const ChurchUpdatePage = (): JSX.Element => {
  ...
  return (
    <div className='animate-fadeInPage'>
      ...
      <SearchTitle isUpdateSearch className='text-orange-500' titleName={'iglesias'} />
        ...
        {isFiltersSearchByTermDisabled && (
          <Form {...form}>
            <form
              ...
              className='grid grid-cols-1 gap-y-2 md:gap-4 items-end mb-8 md:mb-10 md:grid-cols-3 lg:grid-cols-5 lg:gap-5 xl:grid-cols-5 w-auto'
            >
              <FormField
              ...
              <div
                className={cn(
                  'w-full mt-2 md:mt-0 md:col-span-2 lg:col-span-1',
                  !searchType && 'md:col-span-3 lg:col-span-2'
                )}
              >
