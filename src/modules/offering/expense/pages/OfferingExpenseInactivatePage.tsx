...
import { offeringExpenseInactivateColumns as columns } from '@/modules/offering/expense/components/data-tables/columns/offering-expense-inactivate-columns';
...
export const OfferingExpenseInactivatePage = (): JSX.Element => {
  //* States
