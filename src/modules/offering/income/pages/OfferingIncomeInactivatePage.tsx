...
import { offeringIncomeInactivateColumns as columns } from '@/modules/offering/income/components/data-tables/columns/offering-income-inactivate-columns';
...
export const OfferingIncomeInactivatePage = (): JSX.Element => {
  //* States
...
export default OfferingIncomeInactivatePage;
