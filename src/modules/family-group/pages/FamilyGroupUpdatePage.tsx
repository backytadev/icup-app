...
import { familyGroupUpdateColumns as columns } from '@/modules/family-group/components/data-tables/columns/family-group-update-columns';
...
export const FamilyGroupUpdatePage = (): JSX.Element => {
  //* States
