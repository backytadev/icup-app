...
export const PastorCreatePage = (): JSX.Element => {
  ...
  return (
    <div className='animate-fadeInPage'>
      ...
      <h2 className='font- text-left pb-[2px] pt-2 px-4 sm:px-5 2xl:px-10 font-sans font-bold text-green-500 text-[1.6rem] sm:text-[1.75rem] md:text-[1.85rem] lg:text-[1.9rem] xl:text-[2.1rem] 2xl:text-4xl'>
