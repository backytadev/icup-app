  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950'>
      <div className='max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8'>
        <ModuleHeader
          title='Modulo Co-Pastor'
          description='Administra y gestiona la informacion de los co-pastores registrados en el sistema.'
          badge='Membresía'
          badgeColor='cyan'
          titleColor='cyan'
          icon={FiUsers}
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto'>
          <ModuleOptionCard
            to='/copastors/create'
            icon={<FiUsers />}
            title='Registrar Co-Pastor'
            description='Crear nuevo registro de un co-pastor en el sistema.'
            color='green'
          ...
          <ModuleOptionCard
            ...
            description='Buscar, consultar, actualizar e inactivar registros de co-pastores.'
            color='blue'
            delay='0.25s'
          />
        </div>
