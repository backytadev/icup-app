...
import { copastorInactivateColumns as columns } from '@/modules/copastor/components/data-tables/columns/copastor-inactivate-columns';
...
export const CopastorInactivatePage = (): JSX.Element => {
  //* States
  ...
  return (
    <div className='animate-fadeInPage'>
      ...
      <SearchTitle
        isInactivateSearch
        className='-ml-2 sm:ml-0 text-red-500 w-[14.85rem] sm:w-auto whitespace-nowrap'
