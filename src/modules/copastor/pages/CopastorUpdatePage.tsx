...
import { copastorUpdateColumns as columns } from '@/modules/copastor/components/data-tables/columns/copastor-update-columns';
...
export const CopastorUpdatePage = (): JSX.Element => {
  //* States
