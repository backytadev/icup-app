...
import { useCopastorInactivationMutation } from '@/modules/copastor/hooks/useCopastorInactivationMutation';
...
export const CopastorInactivateCard = ({ idRow }: CopastorInactivateCardProps): JSX.Element => {
  ...
  useEffect(() => {
    ...
    if (idRow && isCardOpen) {
      ...
      url.pathname = `/copastors/inactivate/${idRow}/remove`;
    ...
    <Dialog open={isCardOpen} onOpenChange={setIsCardOpen}>
      ...
      >
        <div className='h-auto'>
          ...
          <span className='inline-block mb-2 text-[14.5px] md:text-[15px]'>
            ❌ El registro de este Co-Pastor se eliminara de los lugares donde estaba relacionado
