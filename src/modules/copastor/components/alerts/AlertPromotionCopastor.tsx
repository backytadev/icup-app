    ...
    <AlertDialog>
      ...
      <AlertDialogContent className='w-[90vw]'>
        <AlertDialogHeader className='h-auto'>
          <AlertDialogTitle className='dark:text-yellow-500 text-amber-500 font-bold text-xl text-center md:text-[28px] pb-3 flex flex-col'>
            <p>¿Estás seguro de promover a este</p>
            <p className='w-full text-center md:pt-2'>Co-Pastor?</p>
          </AlertDialogTitle>
          ...
          <AlertDialogDescription>
            ...
            <span className='text-left inline-block mb-2 text-[14px] md:text-[15px] leading-relaxed'>
              ...
              caso, deberás asignar una Iglesia al nuevo Pastor promovido.
            </span>

            <span className='text-left inline-block mb-2 text-[14px] md:text-[15px] leading-relaxed'>
              ✅ Una vez que guardes los cambios, el sistema eliminará automáticamente la relación
              que tenía el líder en su rol anterior con sus supervisores, zonas, predicadores,
              grupos familiares y discípulos.
            </span>
