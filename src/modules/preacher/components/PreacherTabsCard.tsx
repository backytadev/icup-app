...
export const PreacherTabsCard = ({ data, id }: PreacherTabsCardProps): JSX.Element => {
  useEffect(() => {
    ...
    if (id) {
      ...
      url.pathname = `/preachers/search/${id}/view`;
  ...
  return (
    <div className='w-full md:min-w-[680px] -mt-2 md:-mt-6'>
      {/* Header */}
      <div className='relative overflow-hidden rounded-t-xl bg-gradient-to-r from-violet-600 via-purple-600 to-violet-700 dark:from-violet-800 dark:via-purple-800 dark:to-violet-900 px-4 py-4 md:px-6'>
        <div className='flex items-center justify-between gap-3'>
          <div className='flex-1 min-w-0'>
            <div className='flex items-center gap-2 mb-1.5 flex-wrap'>
              <span className='px-2 py-0.5 text-[10px] font-semibold bg-violet-500/20 text-violet-100 rounded font-inter uppercase tracking-wider'>
                Predicador
              </span>
            ...
            <p className='text-violet-100/80 text-[12px] md:text-[13px] font-inter mt-0.5 truncate'>
            ...
            <div className='p-4 md:p-5 space-y-4'>
              ...
              <div className='p-3 rounded-lg bg-slate-50/80 dark:bg-slate-800/30 border border-slate-200/50 dark:border-slate-700/30'>
                <div className='flex items-start gap-2.5'>
                  <div className='p-1.5 rounded-md bg-violet-100 dark:bg-violet-900/30 mt-0.5'>
                    <FiMapPin className='w-4 h-4 text-violet-600 dark:text-violet-400' />
                  </div>
