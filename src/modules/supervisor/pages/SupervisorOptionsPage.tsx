  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950'>
      <div className='max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8'>
        <ModuleHeader
          title='Modulo Supervisor'
          description='Administra y gestiona la informacion de los supervisores registrados en el sistema.'
          badge='Membresía'
          badgeColor='teal'
          titleColor='teal'
          icon={FiUsers}
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto'>
          <ModuleOptionCard
            ...
            description='Crear nuevo registro de un supervisor en el sistema.'
            color='green'
          ...
          <ModuleOptionCard
            to='/supervisors/search'
            icon={<FaSearch />}
            title='Gestionar Supervisores'
            description='Buscar, consultar, actualizar e inactivar registros de supervisores.'
            color='blue'
            delay='0.25s'
          />
        </div>
