...
import { useSupervisorInactivationMutation } from '@/modules/supervisor/hooks/useSupervisorInactivationMutation';
...
export const SupervisorInactivateCard = ({ idRow }: SupervisorInactivateCardProps): JSX.Element => {
  //* States
  ...
  useEffect(() => {
    ...
    if (idRow && isCardOpen) {
      ...
      url.pathname = `/supervisors/inactivate/${idRow}/remove`;
      ...
      >
        <div className='h-auto'>
          <DialogTitle className='dark:text-yellow-500 text-amber-500 font-bold text-[24px] text-center md:text-[28px] pb-3'>
            ¿Estas seguro de inactivar este Supervisor?
          </DialogTitle>
          ...
          <span className='inline-block mb-2 text-[14.5px] md:text-[15px]'>
            ❌ El registro de este Supervisor se eliminara de los lugares donde estaba relacionado
