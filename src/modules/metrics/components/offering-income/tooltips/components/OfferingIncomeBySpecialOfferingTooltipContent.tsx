...
export const OfferingIncomeBySpecialOfferingTooltipContent = (
  ...
  return (
    <div className='min-w-[190px] max-w-[300px] rounded-xl border border-slate-200/80 dark:border-slate-700/60 bg-white dark:bg-slate-900 overflow-hidden shadow-lg'>
      {/* Header */}
      <div className='px-3 py-2 bg-gradient-to-r from-purple-50 to-violet-50/30 dark:from-purple-900/20 dark:to-violet-900/10 border-b border-slate-200/60 dark:border-slate-700/40'>
        <div className='flex items-center gap-2'>
          <div className='p-1 rounded-md bg-purple-500/10 dark:bg-purple-500/20'>
            <TbGift className='w-3.5 h-3.5 text-purple-600 dark:text-purple-400' />
          </div>
