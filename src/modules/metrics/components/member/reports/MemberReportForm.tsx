...
import {
  ...
  MetricMemberSearchTypeNames,
} from '@/modules/metrics/enums/metrics-search-type.enum';
import { memberReportFormSchema } from '@/modules/metrics/schemas/report-form-schema';
import { getMemberMetricsReport } from '@/modules/metrics/services/member-metrics.service';
...
export const MemberReportForm = ({ dialogClose }: Props): JSX.Element => {
        ...
        <div className='flex items-center justify-between gap-3'>
          <div className='flex-1 min-w-0'>
            ...
            <p className='text-amber-100/80 text-[12px] md:text-[13px] font-inter mt-0.5'>
              Selecciona las opciones para el reporte PDF de miembros.
            </p>
          </div>
