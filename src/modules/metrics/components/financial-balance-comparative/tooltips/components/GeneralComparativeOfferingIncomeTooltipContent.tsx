...
export const GeneralComparativeOfferingIncomeTooltipContent = (
  ...
  return (
    <div className='min-w-[190px] max-w-[290px] rounded-xl border border-slate-200/80 dark:border-slate-700/60 bg-white dark:bg-slate-900 overflow-hidden shadow-lg'>
      {/* Header */}
      <div className='px-3 py-2 bg-gradient-to-r from-emerald-50 to-green-50/30 dark:from-emerald-900/20 dark:to-green-900/10 border-b border-slate-200/60 dark:border-slate-700/40'>
        <div className='flex items-center gap-2'>
          <div className='p-1 rounded-md bg-emerald-500/10 dark:bg-emerald-500/20'>
            <TbCoin className='w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400' />
          </div>
