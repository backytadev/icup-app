...
export const FamilyGroupsByCopastorAndZoneTooltipContent = (
  ...
  return (
    <div className='min-w-[190px] max-w-[250px] rounded-xl border border-slate-200/80 dark:border-slate-700/60 bg-white dark:bg-slate-900 overflow-hidden shadow-lg'>
      {/* Header */}
      <div className='px-3 py-2 bg-gradient-to-r from-blue-50 to-blue-50/30 dark:from-blue-900/20 dark:to-blue-900/10 border-b border-slate-200/60 dark:border-slate-700/40'>
        <div className='flex items-center gap-2'>
          <div className='p-1 rounded-md bg-blue-500/10 dark:bg-blue-500/20'>
            <TbUsersGroup className='w-3.5 h-3.5 text-blue-600 dark:text-blue-400' />
          </div>
